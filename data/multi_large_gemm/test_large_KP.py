...
f1 = open('OpenBLAS_single_NN_KP.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_single_NN_KP.txt")
xy2 = f2.read().split("\n")

f4 = open("armpl_single_NN_KP.txt")
xy4 = f4.read().split("\n")

f5 = open("NSMM_single_NN_KP.txt")
xy5 = f5.read().split("\n")
...
f1 = open('openblas_large_NN_thread_KP.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_large_NN_thread_KP.txt")
xy2 = f2.read().split("\n")

f4 = open("armpl_large_NN_thread_KP.txt")
xy4 = f4.read().split("\n")

f5 = open("LibShalom_large_NN_thread_KP.txt")
xy5 = f5.read().split("\n")
...
axs[1].set_yticks((400, 800, 1200, 1600, 2000, 2400),('400', '800', '1200', '1600', '2000', '2400'),fontsize=14)
...
plt.show()
fig.savefig('large_gemm_KP.pdf', bbox_inches='tight')
