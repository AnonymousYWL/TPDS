...
f1 = open('openblas_single_NN_THX.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_single_NN_THX.txt")
xy2 = f2.read().split("\n")

f4 = open("armpl_single_NN_THX.txt")
xy4 = f4.read().split("\n")

f5 = open("NSMM_single_NN_THX.txt")
xy5 = f5.read().split("\n")
...
f1 = open('openblas_large_NN_thread_TH.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_large_NN_thread_TH.txt")
xy2 = f2.read().split("\n")

f4 = open("armpl_large_NN_thread_TH.txt")
xy4 = f4.read().split("\n")

f5 = open("LibShalom_large_NN_thread_TH.txt")
xy5 = f5.read().split("\n")
...
axs[0].set_yticks((5,10,15,20,25,30, 35, 40),('5','10','15','20','25','30', '35', '40'),fontsize=14)
...
axs[1].set_xlabel("M=N=K(32 threads)",fontsize=14)
...
axs[1].set_yticks((200, 400, 600, 800, 1000, 1200),('200', '400', '600', '800', '1000', '1200'),fontsize=14)
axs[1].set_ylim(100,1250)

"""
fig.legend([l1,l2,l4,l5], [ 'OpenBLAS','BLIS','ARMPL','LibShalom'], ncol=4,
	loc="upper right" , borderaxespad=0.,bbox_to_anchor=(0.74,1.025), columnspacing = 0.05, frameon=False,
	prop =font1)
"""
fig.tight_layout()
#plt.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace =0.13, hspace =0.34)
plt.show()
fig.savefig('large_gemm_TH.pdf', bbox_inches='tight')
