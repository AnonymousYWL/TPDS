...
f1 = open('openblas_small_NN_FT.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_small_NN_FT.txt")
xy2 = f2.read().split("\n")

f3 = open("libxsmm_small_NN_FT.txt")
xy3 = f3.read().split("\n")

f4 = open("armpl_small_NN_FT.txt")
xy4 = f4.read().split("\n")

f5 = open("NSMM_small_NN_FT.txt")
xy5 = f5.read().split("\n")

f6 = open("blasfeo_small_NN_FT.txt")
xy6 = f6.read().split("\n")
...
f1 = open('openblas_small_NT_FT.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_small_NT_FT.txt")
xy2 = f2.read().split("\n")

f3 = open("libxsmm_small_NT_FT.txt")
xy3 = f3.read().split("\n")

f4 = open("armpl_small_NT_FT.txt")
xy4 = f4.read().split("\n")

f5 = open("NSMM_small_NT_FT.txt")
xy5 = f5.read().split("\n")

f6 = open("blasfeo_small_NT_FT.txt")
xy6 = f6.read().split("\n")
...
l3,=axs[0].plot(libxsmm_x,y3,color=(238/255,131/255,60/255),label="LIBXSMM",marker="s",markersize=4,markerfacecolor='black',markeredgecolor='black')
...
l6,=axs[0].plot(x,y6,color=(170/255,170/255,170/255),label="BLASFEO",marker="x",markersize=4,markerfacecolor='black',markeredgecolor='black')

axs[0].set_xlabel("M=N=K(NN mode)",fontsize=14)
axs[0].set_ylabel("GFLOPS (FP32)",font)
axs[0].set_xlim(4,205)
axs[0].grid(True,c="lightgrey",linestyle='--')
axs[0].set_xticks((8,40,80,120,160,200),('8','40','80','120','160','200'),fontsize=14)
axs[0].set_yticks((4,8,12,17),('4','8','12','17'),fontsize=14)
axs[0].set_ylim(0,17)
...
l3,=axs[1].plot(libxsmm_x,y33,color=(238/255,131/255,60/255),label="LIBXSMM",marker="s",markersize=4,markerfacecolor='black',markeredgecolor='black')
...
l5,=axs[1].plot(x,y55,color=(255/255,223/255,128/255),label="LibShalom2",marker=">",markersize=4,markerfacecolor='black',markeredgecolor='black')
...
axs[1].set_xlim(4,205)
axs[1].set_xticks((8, 40,80,120,160,200),('8','40','80','120','160','200'),fontsize=14)
axs[1].set_yticks((4,8,12,17),('4','8','12','17'),fontsize=14)
...
fig.legend([l1,l2,l3,l4,l6,l5], [ 'OpenBLAS','BLIS','LIBXSMM','ARMPL','BLASFEO','LibShalom2'], ncol=6,
	loc="upper right" , borderaxespad=0.,bbox_to_anchor=(0.98,1.024), columnspacing = 0.05, frameon=False,
	prop =font1)

fig.tight_layout()
plt.subplots_adjust(left=None, bottom=None, right=None, top=None, wspace =0.05, hspace = 0.34)
plt.show()
fig.savefig('small_gemm_FT.pdf', bbox_inches='tight')
