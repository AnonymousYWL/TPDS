...
f1 = open('openblas_small_NN_KP.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_small_NN_KP.txt")
xy2 = f2.read().split("\n")

f3 = open("libxsmm_small_NN_KP.txt")
xy3 = f3.read().split("\n")

f4 = open("armpl_small_NN_KP.txt")
xy4 = f4.read().split("\n")

f5 = open("NSMM_small_NN_KP.txt")
xy5 = f5.read().split("\n")

f6 = open("blasfeo_small_NN_KP.txt")
xy6 = f6.read().split("\n")
...
f1 = open('openblas_small_NT_KP.txt', 'r')
xy1=f1.read().split("\n")

f2 = open("blis_small_NT_KP.txt")
xy2 = f2.read().split("\n")

f3 = open("libxsmm_small_NT_KP.txt")
xy3 = f3.read().split("\n")

f4 = open("armpl_small_NT_KP.txt")
xy4 = f4.read().split("\n")

f5 = open("NSMM_small_NT_KP.txt")
xy5 = f5.read().split("\n")

f6 = open("blasfeo_small_NT_KP.txt")
xy6 = f6.read().split("\n")
...
plt.show()
fig.savefig('small_gemm_KP.pdf', bbox_inches='tight')
