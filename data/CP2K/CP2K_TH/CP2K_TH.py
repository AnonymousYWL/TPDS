...
f1 = open("blis_CP2K_TH.txt")
xy1 = f1.read().split("\n")

f2 = open('openblas_CP2K_TH.txt', 'r')
xy2=f2.read().split("\n")

f3 = open("armpl_CP2K_TH.txt")
xy3 = f3.read().split("\n")

f4 = open("libxsmm_CP2K_TH.txt")
xy4 = f4.read().split("\n")

f5 = open("blasfeo_CP2K_TH.txt")
xy5 = f5.read().split("\n")

f6 = open("NSMM_CP2K_TH.txt")
xy6 = f6.read().split("\n")
...
plt.xticks(ind,("5x5x5","13x5x13","13x13x13","23x23x23","26x26x13"),
	size = 16)
plt.yticks((0,2,4,6,8,10,12,14),fontsize=20)
...
plt.tight_layout()
plt.show()
#plt.set_title("ThunderX2")

f.savefig('CP2K_TH.pdf', bbox_inches='tight')